package com.example.uijp.view.reminder
...
fun ReminderScreen(navController: NavController, viewModel: ReminderViewModel = viewModel()) {
    ...
    val reminders by viewModel.reminder.collectAsState()
    ...
    Column(modifier = Modifier.fillMaxSize().padding(24.dp)) {
        ...
        Card(
            ...
            Column(
                ...
                Text("Tambah Reminder Baru", fontSize = 18.sp, fontWeight = FontWeight.Bold)
                ...
                // SAVE BUTTON
                Button(
                    modifier = Modifier.fillMaxWidth().clip(RoundedCornerShape(8.dp)).height(40.dp),
                    onClick = {
                    ...
                    colors = ButtonDefaults.buttonColors(
                        ...
                        disabledContainerColor = Color(0xFFF7958F)
                    )
                ) {
